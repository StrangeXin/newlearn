...
export const assistantCapabilityCoverage: AssistantCapabilityCoverageItem[] = [
  ...
  { surface: "/api/assistant/conversations", owner: "assistant conversation management", status: "not-exposed", reason: "Conversation switching is assistant UI state, not a business capability exposed back to the Agent." },
  { surface: "/api/assistant/conversations/[id]", owner: "assistant conversation loading", status: "not-exposed", reason: "Conversation loading is scoped to the current user and only drives the assistant UI." },
  { surface: "/api/assistant/conversations/reset", owner: "assistant context reset", status: "not-exposed", reason: "Context reset starts a new assistant session without changing business data." },
